...
public class MainWindow {
    ...
    private JRadioButtonMenuItem rbRusLang = new JRadioButtonMenuItem("Русский");
    private JRadioButtonMenuItem rbEngLang = new JRadioButtonMenuItem("English", true);
    ...
    public void showAbout() {
        JOptionPane.showMessageDialog(null,null, data.aboutTitle, JOptionPane.INFORMATION_MESSAGE);
    }
